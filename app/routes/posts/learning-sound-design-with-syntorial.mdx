...
The more you learn and research about sound design the better. Syntorial in my opinion is a good starting point to sound design and understanding how to use a subtractive synth. You will be learning how to use the synth to create presets also known as synth patches. There are additional lesson packs for popular soft synth like [Serum](https://xferrecords.com/products/serum), [Massive](https://www.native-instruments.com/en/products/komplete/synths/massive), and [Sylenth1](https://www.lennardigital.com/sylenth1). Highly recommend picking one soft synth to master before exploring others.

All the lessons are well structured and build upon each other. It will be going over all the sections, kobs, sliders and dropdown selections on a soft synth. Each lesson focuses on teaching you one small section of the soft synth. It's a lot easier to learn a small part of a synth at a time. The end goal is to learn how to create a sound by ear.
