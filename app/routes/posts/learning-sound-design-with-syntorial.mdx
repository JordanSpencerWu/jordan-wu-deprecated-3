...
All the lessons are well structured and build upon each other. It goes over all the sections, kobs, sliders and dropdown selections on a soft synth. And each lesson focuses on teaching you one small section of the soft synth, making it easier to learn. The goal is to learn how to create a sound by ear.
...
![Filter envelope](https://s3.us-west-2.amazonaws.com/jordanwu.xyz.images/learning-sound-design-with-syntorial/filter-envelope-cutoff-and-envelope-knobs.png "Filter envelope cutoff frequency and envelope amount")
...
![Filter envelope with attack and release stage](https://s3.us-west-2.amazonaws.com/jordanwu.xyz.images/learning-sound-design-with-syntorial/filter-envelope-attack-and-release.png "Filter envelope with attack and release stage")
...
![Amplitude envelope with attack, decay, and sustain stage](https://s3.us-west-2.amazonaws.com/jordanwu.xyz.images/learning-sound-design-with-syntorial/filter-envelope-cutoff-and-envelope-knobs.png "Amplitude envelope with attack, decay, and sustain stage")
...
<details>
<summary>9. Changing Brightness While Holding</summary>

The both the filter envelope decay and sustain slider control changing the brightness of your sound while the key is pressed. The decay slider deteremines how quickly the brightness changes to the sustain level. The sustain level is determined by the cutoff knob.

![Filter envelope with attack, decay, and sustain stage](https://s3.us-west-2.amazonaws.com/jordanwu.xyz.images/learning-sound-design-with-syntorial/filter-envelope-attack-decay-and-sustain.png "Filter envelope with attack, decay, and sustain stage")

</details>

<details>
<summary>10. Bottom End</summary>

A sub oscillator has a fixed pitch one octave below oscillator one. It's purpose is to add bottom end and weight to your sound. If you hear a attack transient, you can remove it using the Amp envelope attack stage.

</details>

<details>
<summary>11. Repeating Movement</summary>

The low frequency oscillator LFO is used for repeating movement. It does this by using a waveform to modulate one of many destinations. To add Vibrato or Tremolo to a patch an LFO would be used to modulate the pitch and amplitude respectively.
...
> - Destination: Volume
> - Waveform: Triangle
> - Amount: Medium to High
> - Rate: Medium to Fast

> #### Gate
>
> - Destination: Volume / Cutoff
> - Waveform: Saw / Pulse
> - Amount: Medium to High
> - Rate: Medium to Fast
...
<details>
<summary>12. Point</summary>

Filter resonance boosts your sound near its brightest point determined by the cutoff frequency. Resonance can tighten, focus and add points to your sound.

When you turn the resonance all the way, changing the cutoff frequency changes the pitch of the sound. This is called self-oscillation.

</details>

<details>
<summary>13. So Many Notes!</summary>

Voice modes determine how many notes can be played at once. Mono mode only allows playing one voice / note at a time. In poly mode you can play two or more voices / notes. Mono mode is used to force single note playing, good for bass and leads.

</details>

<details>
<summary>14. Bigger is Better</summary>

Union is a way to create a bigger sound by adding more voices. A voice is a oscillator that is detuned and can be adjusted. The spread knob spread the sound between the right and left audio field.
